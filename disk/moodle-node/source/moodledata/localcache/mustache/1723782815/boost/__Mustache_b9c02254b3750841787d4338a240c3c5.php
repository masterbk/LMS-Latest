...
class __Mustache_b9c02254b3750841787d4338a240c3c5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockB7834d3c8d8bcaba35ddada589cb2c9a'),
            ));
...
';
    ...
    public function blockB7834d3c8d8bcaba35ddada589cb2c9a($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
