...
class __Mustache_2e24f087b92346a37c86345287c5015e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block9a66fc4cc3c70445740471316dff15ca'),
            ));
...
';
    ...
    public function block9a66fc4cc3c70445740471316dff15ca($context)
    {
        $indent = $buffer = '';
